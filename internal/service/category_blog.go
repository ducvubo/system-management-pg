...
type (
	ICategoryBlog interface {
		...
		GetAllCategoryBlog(ctx context.Context, Limit int32, Offset int32, isDeleted int32,CatName string) (out response.ModelPagination[[]*model.CategoryBlogOutput], err error, statusCode int)
